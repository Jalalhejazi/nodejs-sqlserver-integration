/**
    Code Injection as a solution for integration between
    SQLSERVER and EXPRESS 
...
function SqlServer_integration(config){
    ...
    return function(sqlQueryText) {
        ...
        return {
            ...
            output: function(ostream, defaultOutput = "[]") {
                var request = this.__createRequest(ostream);
                var self = this;
            ...
            __createRequest: function(ostream){
                ...
                for(var index in this.parameters) {
                    request.addParameter(
                        ...
                        this.parameters[index].type || require('tedious').TYPES.NVarChar,
...
module.exports = SqlServer_integration;